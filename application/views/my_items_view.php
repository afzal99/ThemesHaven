			...
			<div class="item_area">
				<ul>
					<?php
						if($mypro_row >'0')
						{
							foreach ($my_product as $key) { ?>
								<li class="f_block">

									<div class="block_img"><div class="imghover"><a href="<?php echo site_url(); ?>item/template/<?php echo $key['product_id'] ?>" class="btn btn-default viewdetail">View detail</a> <a href="<?php echo site_url(); ?>dashboard/withdraw/<?php echo $key['product_id'] ?>" onclick="return confirm('Are you sure want to withdraw this product?')" class="btn btn-default withdraw">Withdraw</a></div><img src="<?php echo site_url(); ?>site_elements/image/<?php echo $key['image']; ?>" width="280px" height="192px"/></div>
									<div class="block_info"> 
										<div class="theme_title"><h3> <?php echo $key['title']; ?> </h3></div>
										<div class="theme_info">
											<h4 class="price"><?php if($key['price'] !='Free' && $key['price'] !='Pending'){echo '$';} echo $key['price']; ?></h4>
						...
						{
							echo '<span style="margin-left:25px">You don\'t have any product !</span>';
						}
					?>
...
function confirmation() {
    ...
    'title':    'Information',
    'buttons':  [
                    {caption: 'Ok', callback: function() {true}},
                    {caption: 'Cancel', callback: function() {false }}
                ]
	});
}
</script>
