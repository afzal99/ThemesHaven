	...
	<div id="d_main">
		...
		<div id="item_label">
			<div id="item_label_content">
				<h4 class="wiz"> <a href="<?php echo site_url('home'); ?>">Home </a>/ Reset Password</h4>
		...
		<div id="canvas">
			...
			<div id="form_area">
			<form class="form-horizontal"  autocomplete="off" role="form" method="post" action="<?php echo site_url('account/resetpassword'); ?>">
				...
				<p style="margin-top:5px; margin-left:26%;"><button style="width:120px;" type="submit" name="submit" class=" btn btn-primary"> Submit </button></p>
			</form>
			</div>
