...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>site_elements/information_style.css"/>
...
<body>
	<div id="d_main">
		...
		<div id="item_label"><?php foreach ($result as $key) { ?>
			<div id="item_label_content">
				<h4 class="wiz"> <a href="<?php echo site_url('home'); ?>">Home </a>/ <?php echo $key['title']; ?></h4>
				<span id="info_title">
					<p><?php echo $key['title']; ?>
				</span></p>
			</div>
		</div>
		<div id="canvas">
