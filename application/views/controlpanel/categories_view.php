	    		...
	    		<table class="table table-hover table-bordered">
	    			...
	    			<?php foreach ($categories as $key): $segment++; ?>
	    				<tr>
                            ...
                            <td class="center">[ <a href="<?php echo site_url('controlpanel/Categories/view/'.$key['id']); ?>">View</a> ]  [ <a onClick='return confirm("Are you sure want to delete this category ?");' href="<?php echo site_url('controlpanel/Categories/delete/'.$key['id']); ?>">Delete</a> ]</td>
