...
<body>
	<div id="d_main">
		...
		<div id="item_label">
			<div id="item_label_content">
				...
				<ul class="nav nav-tabs">
				  ...
				  <div id="btn_submit" class="pull-right"><a href="dashboard/submitdesign"><span class="glyphicon glyphicon-ok-circle"></span>SUBMIT AN ITEM</a></div>
		...
		<div id="canvas">
			...
			<div id="info_buttons">
				<span class="btn_info_general thismonth" href="#">
					This Month Earnings   <p>$0</p>
				</span>
				<span class="btn_info_general todays" href="#">
					Todays Earnings   <p>$0</p>
				</span>
				<span class="btn_info_general alltimes" href="#">
					All time Earnings   <p>$0</p>
				</span>
