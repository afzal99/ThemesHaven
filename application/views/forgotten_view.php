...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo site_url(); ?>site_elements/forgotten_style.css"/>
	...
	<div id="d_main">
		...
		<div id="item_label">
			<div id="item_label_content">
				<h4 class="wiz"> <a href="<?php echo site_url('home'); ?>">Home </a>/<a href="<?php echo site_url('account/forgotten'); ?>"> Forgotten Password </a></h4>
		...
		<div id="canvas">
			...
			<div  id="canvas_header" style="padding-left:0" class="col-md-12" >
				...
				Enter the e-mail address associated with your account. Click submit to have a temporary password reset link e-mailed to you.
			</div>

			<h4>Your E-Mail Address</h4>
			<div id="form_area">
			<form class="form-inline"  role="form" method="post" action="<?php echo site_url('account/forgetpassword'); ?>">
  				<div class="form-group">
					<label>E-Mail Address:</label>
					<input type="text" name="email" class="form-control" /><span><?php if($this->session->flashdata('error')){echo $this->session->flashdata('error'); } ?></span>
				</div>
				
				<p style="margin-top:5px;"><button type="submit" name="submit" class="btn btn-primary"> Submit </button></p>
			</form>
			</div>
